    ...
    return(
        <div className="container">
            <SimpleImageSlider
                ...
                loop={true}
            />
            <iframe style={{visibility: "hidden"}} width="560" height="315" src="https://www.youtube.com/embed/pzK3_MA1Al4?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    )
}